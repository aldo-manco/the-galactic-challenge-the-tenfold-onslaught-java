...
public class MultiPlayerLevel {
    ...
    public MultiPlayerLevel(Player player, EnemyBulletHandler bulletHandler, int limit, double speedEnemies, int scoreIncrement, int violence, int currentLevel, int rowsOfEnemies) {
        ...
        for (int y = 0; y < rowsOfEnemies; y++) {
            ...
            for (int x = 0; x < 10; x++) {
                ...
                if (rowsOfEnemies == 5) {
                    switch (y) {
                        case 0:
                            enemy = new EnemyTypeBasic(150 + (x * 40), 25 + (y * 40), 1, 3, bulletHandler, speedEnemies, scoreIncrement, violence, 2, "/org/aldomanco/media/sprites/Invader1.png");
                            break;
                        case 1:
                            enemy = new EnemyTypeBasic(150 + (x * 40), 25 + (y * 40), 1, 3, bulletHandler, speedEnemies, scoreIncrement, violence, 2, "/org/aldomanco/media/sprites/Invader2.png");
                            break;
                        case 2:
                            enemy = new EnemyTypeBasic(150 + (x * 40), 25 + (y * 40), 1, 3, bulletHandler, speedEnemies, scoreIncrement, violence, 2, "/org/aldomanco/media/sprites/Invader3.png");
                            break;
                        case 3:
                            enemy = new EnemyTypeBasic(150 + (x * 40), 25 + (y * 40), 1, 3, bulletHandler, speedEnemies, scoreIncrement, violence, 2, "/org/aldomanco/media/sprites/Invader4.png");
                            break;
                        case 4:
                            enemy = new EnemyTypeBasic(150 + (x * 40), 25 + (y * 40), 1, 3, bulletHandler, speedEnemies, scoreIncrement, violence, 2, "/org/aldomanco/media/sprites/Invader6.png");
                            break;
                    }
                    ...
                    switch (y) {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            enemy = new EnemyTypeBasic(150 + (x * 40), 25 + (y * 40), 1, 3, bulletHandler, speedEnemies, scoreIncrement, violence, 2, "/org/aldomanco/media/sprites/Invader5.png");
                            break;
                        case 5:
                            enemy = new EnemyTypeBasic(150 + (x * 40), 25 + (y * 40), 1, 3, bulletHandler, speedEnemies, scoreIncrement, violence, 2, "/org/aldomanco/media/sprites/Invader6.png");
                            break;
